...
public class mod_region extends Region {
    public mod_region(ResourceLocation name, int weight)
    {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        this.addModifiedVanillaOverworldBiomes(mapper, builder -> {
            ...
            frozenPeaksPoints.forEach(point -> builder.replaceBiome(point, mod_biomes.COLD_BLUE));
        });
    }
}